...
df_cd_sample <- read.csv("C:/Users/Lvu/Internal - Analytics/constituents_raw_data.csv", 
                         encoding="ISO-8859-1")

# Set the Python environment
# virtualenv_path <- "C:/Users/Lvu/git/ccs_data_preprocessing/.py3117_preprocessing"
virtualenv_path <- "./.py3117_preprocessing"
Sys.setenv(RETICULATE_PYTHON = file.path(virtualenv_path, "Scripts/python.exe"))

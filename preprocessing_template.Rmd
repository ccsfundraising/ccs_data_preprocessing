...
virtualenv_create("reticulate_preprocessing")

# Install required Python libraries
virtualenv_install("reticulate_preprocessing", requirements = "./requirements.txt")

# Specify the path to the virtual environment
use_virtualenv("reticulate_preprocessing", required = TRUE)
